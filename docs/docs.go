...
const docTemplate = `{
    ...
    "paths": {
        "/async/analyses": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Status filter (defaults to Running)",
                        "name": "status",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.AnalysesListResponse"
                        }
                    },
                    "503": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.AsyncDeleteUserResponse"
                        }
                    },
                    "503": {
                        "description": "Service Unavailable (Terrain not configured)",
        ...
        "/datastore/users": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datastore User details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.DatastoreUserRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.UserResponse"
                        }
                    },
                    "422": {
                        "description": "Validation error",
                    ...
                    "500": {
                        "description": "Failed to create datastore user",
                        "schema": {
                            "$ref": "#/definitions/kinds.GenericResponse"
                        }
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.UserExistsResponse"
                        }
                    },
                    "500": {
                        "description": "Failed to check user existence in data store",
                        "schema": {
                            "$ref": "#/definitions/kinds.GenericResponse"
                        }
                    }
        ...
        "/datastore/users/{username}/services": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Datastore Service Details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.DatastoreServiceRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to register datastore service",
                        "schema": {
                            "$ref": "#/definitions/kinds.GenericResponse"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.EmailRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Either text_body or html_body must be provided",
                        "schema": {
                            "$ref": "#/definitions/kinds.GenericResponse"
                        }
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/kinds.LDAPGroupInfo"
                            }
                        }
                    }
                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.CreateUserRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ldap/users/search": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Usernames to look up",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.UserLDAPSearchRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "413": {
                        "description": "Too many usernames in one request",
                        "schema": {
                            "$ref": "#/definitions/kinds.GenericResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.UserLDAPInfo"
                        }
                    },
                    "404": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.UserAttributeModifyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/mailinglists/{listname}/members": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.MailingListMembersResponse"
                        }
                    },
                    "503": {
                        "description": "Service Unavailable (Mailman integration disabled)",
                        "schema": {
                            "$ref": "#/definitions/kinds.GenericResponse"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Mailing list member details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.MailingListMemberRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.EmailExistsResponse"
                        }
                    },
                    "503": {
                        "description": "Service Unavailable (Mailman integration disabled)",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.PortalEmailExistsResponse"
                        }
                    },
                    "503": {
                        "description": "Portal database not configured",
                        "schema": {
                            "type": "object",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.PortalCreateUserRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/kinds.PortalCreateUserResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.PortalUserExistsResponse"
                        }
                    },
                    "503": {
                        "description": "Portal database not configured",
        ...
        "/portal/users/{username}/validate": {
            "post": {
                "security": [
                    {
                        "BasicAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.UsernameValidationResponse"
                        }
                    },
                    "503": {
                        "description": "Portal database not configured",
        ...
        "/terrain/users/{username}/job-limits": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.JobLimitsResponse"
                        }
                    },
                    "404": {
                        "description": "No job limits configured",
                        "schema": {
                            "$ref": "#/definitions/kinds.GenericResponse"
                        }
                    },
                    "500": {
                        "description": "Failed to retrieve job limits",
                        "schema": {
                            "$ref": "#/definitions/kinds.GenericResponse"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Job Limit Details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.JobLimitsRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to set job limits",
                        "schema": {
                            "$ref": "#/definitions/kinds.GenericResponse"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kinds.PasswordChangeRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kinds.ValidateResponse"
                        }
                    },
                    "422": {
                        "description": "Validation error",
    ...
    "definitions": {
        "kinds.AnalysesListResponse": {
            "type": "object",
            "properties": {
                "analyses": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kinds.AnalysisListItem"
                    }
                }
            }
        },
        "kinds.AnalysisListItem": {
            "type": "object",
            "properties": {
                "analysis_id": {
                    "type": "string"
        ...
        "kinds.MailingListMemberRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "kinds.MailingListMembersResponse": {
            "type": "object",
            "properties": {
                "listname": {
                    "type": "string"
        ...
        "kinds.PortalCreateUserResponse": {
            "type": "object",
            "properties": {
                "user": {
                    "type": "string"
        ...
        "kinds.PortalEmailExistsResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "kinds.PortalUserExistsResponse": {
            "type": "object",
            "properties": {
                "exists": {
                    "type": "boolean"
        ...
        "kinds.UserAttributeModifyRequest": {
            "type": "object",
            "properties": {
                "value": {
                    "type": "string"
        ...
        "kinds.UsernameValidationResponse": {
            "type": "object",
            "properties": {
                "reason": {
                    "type": "string"
        ...
        "kinds.ValidationErrorResponse": {
            "type": "object",
            "properties": {
                "detail": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kinds.ValidationError"
                    }
                }
            }
        }
